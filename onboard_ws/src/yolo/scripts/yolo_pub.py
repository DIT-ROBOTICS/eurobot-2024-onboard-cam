...
Xoffset=0 # X distance of the camera to robot center, units in meter
Zoffset=0 # Z distance of the camera to robot center, units in meter
theta=0 #camera depression angle, units in degree
...
# Model
model = YOLO("src/yolo/weight/onboard_cam.pt")
...
while True:
    ...
    # Create a message
    msg = yolomsg()
    msg.x = []  # Initialize as a list
    msg.y = []  # Initialize as a list
    ...
    cv2.putText(img, f'Confidence: {confidence}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
