...
if("TRUE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /home/realsense-ws/src/image_pipeline/image_publisher)
  set(image_publisher_DEVEL_PREFIX /home/realsense-ws/devel)
  ...
  set(image_publisher_INSTALL_PREFIX /home/realsense-ws/install)
...
if(NOT "/home/realsense-ws/devel/include " STREQUAL " ")
  set(image_publisher_INCLUDE_DIRS "")
  set(_include_dirs "/home/realsense-ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/realsense-ws/src/image_pipeline/image_publisher/${idir}'.  ${_report}")
    endif()
