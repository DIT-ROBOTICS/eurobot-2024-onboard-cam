...
namespace dbscan {
    ...
    void analyzeAndPrintObjectInfo(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& cloud_cluster) {
        ...
        is_safe_msg.data = min_distance >= 0.3; // True if the nearest point is at least 30 cm away
    ...
    void initialize(ros::NodeHandle& nh) {
        ...
        cloud_sub = nh.subscribe("/cam_pcl_1/differential/ladybug/cube", 1, cloudCallback);
